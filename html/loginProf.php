                ...
                <form action="loginConfig.php" method="POST" class="sign-in-form">
                    ...
                    <div class="input-field">
                        ...
                        <form action="#" class="sign-up-form">
                            ...
                            <div>
                            <input type="radio" name="Professors Committee" id="yes" checked="checked"/>
                            <label for="yes">Professors Committee</label>
                            <input type="radio" name="Professors Committee" id="no">
                            <label for="no"> Ordinary Professor</label></div> <br> 
                    ...
                    <div class="panels-container">
                        <div class="panel left-panel">
                          ...
                          <img src="../img/Lesson-bro.png" class="image" alt="" />
                        </div>
                        <div class="panel right-panel">
                          ...
                          <img src="../img/Classroom-bro.png" class="image" alt="" />
                        </div>
                      </div>
                    </div>
